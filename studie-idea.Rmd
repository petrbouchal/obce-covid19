...
# Aglomerace
V této části práce využíváme definici aglomeračních celků použité ve Strategii regionálního rozvoje ČR (SRR21+) ^[Vedle SRR, zpracované Ministerstvem pro místní rozvoj, definuje aglomerace v České republice i studie [OECD](https://www.oecd.org/cfe/regionaldevelopment/functionalurbanareasbycountry.htm). Ta se liší kritérii, podle kterých jsou sestavovány aglomerační oblasti. SRR kombinuje vícero metod pro výpočet syntetického koeficientu (více [zde](https://metropolitni.brno.cz/wp-content/uploads/2020/06/PrF_200120_ZAVERECNY-DOKUMENT_FINAL_02042020.pdf)), zatímco OECD používá výhradně dojížďku za prací. Ačkoli rozdíly ve výsledném vymezení aglomerací často nejsou významné, například v případě Ostravy se výsledné metropolitní oblasti výrazně liší o téměř 300 tisíc obyvatel.].
Ta určuje 12 aglomerací a definuje tři metropole - Prahu, Ostravu a Brno.
